            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8 auto-rows-min">
                ...
                <div class="glass-panel p-0 custom-rounded-2rem flex flex-col lg:flex-row relative overflow-hidden group md:col-span-2 lg:col-span-3 border-t border-cyan-500/20 hover:border-cyan-400/50">
                    ...
                    <div class="w-full lg:w-7/12 relative custom-min-h-250 custom-sm-min-h-300 custom-lg-min-h-350 overflow-hidden flex items-center justify-center bg-black/20">
                        ...
                        <div class="absolute inset-0 custom-bg-gradient-to-t custom-lg-bg-gradient-to-r from-[#050505] via-transparent to-transparent z-10 pointer-events-none"></div>
                    </div>
                </div>
                ...
                <div class="glass-panel p-0 custom-rounded-2rem flex flex-col-reverse lg:flex-row relative overflow-hidden group md:col-span-2 lg:col-span-3 border-t border-indigo-500/20 hover:border-indigo-400/50 bg-[#0a0a0c]">
                    ...
                    <div class="w-full lg:w-1/2 relative custom-min-h-250 custom-sm-min-h-350 overflow-hidden flex items-center justify-center p-6 custom-bg-gradient-to-b custom-lg-bg-gradient-to-r from-transparent via-white/5 to-white/5">
                        ...
                        <img src="{{ asset('images/ctb.webp') }}" alt="CTB Architecture" class="relative z-10 w-full max-w-lg h-auto object-contain transform group-hover:scale-105 transition-transform duration-[2s] ease-out drop-shadow-2xl">
                    </div>
                </div>
                ...
                <div class="glass-panel p-6 md:p-10 custom-rounded-2rem flex flex-col lg:flex-row gap-10 items-center md:col-span-2 lg:col-span-3 border-t border-cyan-500/20 group relative overflow-hidden">
                    ...
                    <div class="w-full lg:w-1/2 relative flex justify-center">
                        <img src="{{ asset('images/ied.webp') }}" alt="11-in-1 Drive Unit" class="w-full max-w-md h-auto object-contain transform group-hover:scale-105 transition-transform duration-[2s] drop-shadow-[0_0_30px_rgba(34,211,238,0.2)]">
                    </div>
                </div>
