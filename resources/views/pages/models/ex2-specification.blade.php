    ...
    <div class="w-full overflow-hidden pt-24 pb-24 relative min-h-screen">
        ...
        <div class="custom-max-w-1600 mx-auto px-4 sm:px-8 md:px-12 lg:px-16 xl:px-20 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8 auto-rows-min">
                ...
                <div class="glass-panel custom-rounded-2rem md:col-span-2 lg:row-span-2 relative overflow-hidden group h-full flex flex-col justify-between">
                ...
                <div class="glass-panel p-6 md:p-8 custom-rounded-2rem flex flex-col justify-center items-center text-center h-full relative overflow-hidden">
                ...
                <div class="glass-panel p-6 sm:p-8 custom-rounded-2rem h-full flex flex-col md:col-span-2 lg:col-span-1">
                    <div class="flex items-center gap-3 mb-6">
                ...
                <div class="glass-panel p-0 custom-rounded-2rem flex flex-col-reverse lg:flex-row relative overflow-hidden group md:col-span-2 lg:col-span-3 border-t border-indigo-500/20 hover:border-indigo-400/50 bg-[#0a0a0c]">
                    ...
                    <div class="w-full lg:w-5/12 relative custom-min-h-200 custom-sm-min-h-250 overflow-hidden flex items-center justify-center p-6 custom-bg-gradient-to-b custom-lg-bg-gradient-to-r from-transparent via-white/5 to-white/5">
                        ...
                        <img src="https://assets.zyrosite.com/Yle46KEPN6IkVONg/space-2-m-mExBnw2wvEFt7MRV.webp" alt="Space Utilization" class="relative z-10 w-2/3 custom-max-w-250 h-auto object-contain transform group-hover:scale-105 transition-transform duration-[2s] ease-out drop-shadow-2xl">
                    </div>
                </div>
                ...
                <div class="glass-panel p-6 md:p-10 custom-rounded-2rem flex flex-col lg:flex-row gap-10 items-center md:col-span-2 lg:col-span-3 border-t border-cyan-500/20 group relative overflow-hidden">
                    ...
                    <div class="w-full lg:w-1/2 relative flex justify-center">
                        <img src="https://assets.zyrosite.com/Yle46KEPN6IkVONg/ex2_11-1-cuE0iVuLy4jreDeI.jpg" alt="11-in-1 Drive Unit" class="w-full max-w-md h-auto custom-rounded-2rem object-cover transform group-hover:scale-105 transition-transform duration-[2s] drop-shadow-[0_0_30px_rgba(34,211,238,0.2)] opacity-80 mix-blend-screen border border-white/10">
                    </div>
                </div>
                ...
                <div class="glass-panel p-0 custom-rounded-2rem overflow-hidden flex flex-col md:flex-row md:col-span-2 lg:col-span-3 border-t border-white/10 group bg-[#06070a]">
                    <div class="w-full md:w-7/12 relative custom-min-h-300 overflow-hidden">
                        ...
                        <div class="absolute inset-0 custom-bg-gradient-to-r from-[#06070a] via-transparent to-transparent z-10"></div>
                    </div>
                ...
                <div class="glass-panel p-0 custom-rounded-2rem flex flex-col lg:flex-row relative overflow-hidden group md:col-span-2 lg:col-span-3 border-t border-blue-500/20 hover:border-blue-500/40 transition-colors duration-500">
                    ...
                    <div class="w-full lg:w-7/12 relative custom-min-h-300 custom-md-min-h-400 custom-lg-min-h-500 overflow-hidden bg-black">
                        ...
                        <div class="absolute inset-0 custom-bg-gradient-to-t custom-lg-bg-gradient-to-r from-[#050505] via-transparent to-transparent pointer-events-none z-10"></div>
                    </div>
                </div>

                <div class="glass-panel p-0 custom-rounded-2rem flex flex-col lg:flex-row-reverse relative overflow-hidden group md:col-span-2 lg:col-span-3 border-t border-cyan-500/20 hover:border-cyan-400/40 bg-[#08080a]">
                    ...
                    <div class="w-full lg:w-6/12 relative custom-min-h-350 custom-md-min-h-450 lg:min-h-full overflow-hidden">
                        ...
                        <div class="absolute inset-0 custom-bg-gradient-to-t custom-lg-bg-gradient-to-l from-[#08080a] via-[#08080a]/30 to-transparent z-10"></div>
